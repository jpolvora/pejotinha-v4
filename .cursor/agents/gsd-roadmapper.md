...
Reference full template: `L:/source/pejotinha-v4/.cursor/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `L:/source/pejotinha-v4/.cursor/get-shit-done/templates/state.md`.
