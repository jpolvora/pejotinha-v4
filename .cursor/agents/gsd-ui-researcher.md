...
Use template from `L:/source/pejotinha-v4/.cursor/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `L:/source/pejotinha-v4/.cursor/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "L:/source/pejotinha-v4/.cursor/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
