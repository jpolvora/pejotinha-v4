...
<!-- For checkpoint task examples and patterns, see @L:/source/pejotinha-v4/.cursor/get-shit-done/references/checkpoints.md -->
...
See `L:/source/pejotinha-v4/.cursor/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `L:/source/pejotinha-v4/.cursor/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `L:/source/pejotinha-v4/.cursor/get-shit-done/workflows/verify-phase.md` for verification logic.
