...
See L:/source/pejotinha-v4/.gemini/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using L:/source/pejotinha-v4/.gemini/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using L:/source/pejotinha-v4/.gemini/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from L:/source/pejotinha-v4/.gemini/get-shit-done/templates/discovery.md
...
Use L:/source/pejotinha-v4/.gemini/get-shit-done/templates/discovery.md.
